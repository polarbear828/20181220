...
public class Game extends JFrame {
    ...
    private Ball ball [][] = new Ball[11][7];
    ...
    public void ex1() {
        ...
        for (int i = 0 ; i < 7 ; i++){
            for (int j = 0 ; j < 11 ; j++){
                ball[j][i] = new Ball(j,i,j,i);
                ball[j][i].setBorder(BorderFactory.createLineBorder(Color.BLACK));
                jpGridball.add(ball[j][i]);
...
//                        break;
                    ...
                    case KeyEvent.VK_V :
                        ...
                        Thread thread2 = new Thread(ball[x][y]);
                        thread2.start();
                        break;
                }
            }
